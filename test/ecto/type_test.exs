defmodule Ecto.TypeTest do
  ...
  describe "utc_datetime" do
    ...
    test "cast negative datetime" do
      assert Ecto.Type.cast(:utc_datetime, "-2015-01-23 23:50") ==
               {:ok, ~U[-2015-01-23 23:50:00Z]}

      assert Ecto.Type.cast(:utc_datetime, "-2015-01-23 23:50:07") ==
  ...
  describe "format/1" do
    test "parameterized type with format/1 defined" do
      ...
      assert Ecto.Type.format({:parameterized, {CustomParameterizedTypeWithFormat, params}}) ==
    ...
    test "parameterized type without format/1 defined" do
      ...
      assert Ecto.Type.format(type) ==
               "#Ecto.TypeTest.CustomParameterizedTypeWithoutFormat<%{key: :value}>"
    end
